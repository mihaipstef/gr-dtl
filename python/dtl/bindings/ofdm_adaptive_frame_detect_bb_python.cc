...
#include <ofdm_adaptive_frame_detect_bb_pydoc.h>

void bind_ofdm_adaptive_frame_detect_bb(py::module& m)
{

    using ofdm_adaptive_frame_detect_bb = ::gr::dtl::ofdm_adaptive_frame_detect_bb;


    py::class_<ofdm_adaptive_frame_detect_bb,
               gr::sync_block,
               gr::block,
               gr::basic_block,
               std::shared_ptr<ofdm_adaptive_frame_detect_bb>>(
        m, "ofdm_adaptive_frame_detect_bb", D(ofdm_adaptive_frame_detect_bb))
