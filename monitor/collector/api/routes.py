...
@flask_app.route("/pair", methods=['GET'])
...
@flask_app.route("/pair/<pair_id>/monitor_data", methods=['GET'])
...
@flask_app.route("/pair/subscribe", methods=['POST'])
...
@flask_app.route("/pair/<id>", methods=["GET"])
